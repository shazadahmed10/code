...
data &nxt;
infile "C:\Users\lqa9\Desktop\18Q4 Data\Site\MER_Structured_Dataset_SITE_IM_FY17-18_20181115_v1_1_&nxt..txt"
...
***Only Fy18 uses age/sex/result and age aggregated/sex/result, so keep only those rows for Fy18. Drop Fy17 values for those disaggs**;
 data &nxt._2;
 set &nxt._1;
if (FY2018Q1 = . & Fy2018Q2 = . & FY2018Q3 = . & FY2018Q4 = . ) & StandardizedDisaggregate IN 
...
& FY2018_TARGETS =. & FY2018Q1 =. & FY2018Q2 = . & FY2018Q3 = . & FY2018Q4 = . & FY2018APR = .) then delete;
run;
...
dbms = excel outfile = "\\cdc.gov\private\M333\lqa9\HTS\HITS 1.0\FY18Q4\Datasets\&todaydate._&nxt._HITS.xlsx"
replace;
sheet = "SiteMSD";
run;
